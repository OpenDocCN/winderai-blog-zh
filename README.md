...
> 原文：[WinderAI Blog](https://winder.ai/blog/)
> 
...
* [在线阅读](https://winderai.apachecn.org)
...
*   在我们的 [apachecn/winderai-blog-zh](https://github.com/apachecn/winderai-blog-zh) github 上提 issue.
...
```
docker pull apachecn0/winderai-blog-zh
docker run -tid -p <port>:80 apachecn0/winderai-blog-zh
...
```
pip install winderai-blog-zh
winderai-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g winderai-blog-zh
winderai-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
